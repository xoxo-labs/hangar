...
export function ResourceMetrics({
  ...
  return (
    <section className={SECTION} onPointerLeave={() => setHoveredIndex(null)}>
...
function Metric({
  ...
  return (
    <div className="flex min-h-[100px] flex-col rounded-md border border-surface-5 bg-surface-a2 p-[9px]">
      <span className="text-xs text-surface-9">{label}</span>
...
function Sparkline({
  ...
  const selectionX =
    selectedRange === null || values.length < 2
      ? null
      : {
  ...
  return (
    ...
    >
      {coverage < 1 && (
        <rect className="pointer-events-none fill-surface-a3" x="0" y="0" width={plotStart} height="28" />
      )}
