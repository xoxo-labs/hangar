...
const MENU_ITEM =
  "flex justify-between rounded-sm px-[8px] py-[6px] text-left text-base text-surface-11 enabled:hover:bg-surface-a4 enabled:hover:text-surface-12 disabled:cursor-default disabled:opacity-35"

/** Port of `.terminal-menu kbd` — `font: inherit` resolves to the body sans stack. */
const MENU_KBD = "font-sans text-xs text-surface-8"
